---
title: Cephaloziella varians
url: /taxa/Cephaloziella varians
image: "../img/XXXXXX"
categories:
  - Marchantiophyta
---
...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Cephaloziella varians</div>
...
<a href="https://www.gbif.org/species/ (Gottsche) Steph.</span>
...
<table>
<tr><td class="info-label">Common Name</td><td class="info-value">Arctic Threadwort</td></tr>
...
Species of <a href="/taxa/Cephaloziella">Cephaloziella</a> and <a href="/taxa/Eremonotus myriocarpus">Eremonotus myriocarpus</a> are the only plants that approach the sub millimeter scale. C. varians, however, is the only one amongst these that has rounded lobe tips on its tiny leaves. 
...
XXXXXX
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Cephaloziella varians.csv"); 
 </script>
