...
url: /taxa/Vinealobryum norrisii
...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Vinealobryum norrisii</div>
...
<div class="imerss-image-header">
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Mosses&#x2F;Pottiaceae&#x2F;Vinealobryum_norrisii&#x2F;macro_pics&#x2F;VINENOR_AS_iNat_01.jpg)"
       title="Andrew Simon">
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo1">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo1">
                      Vinealobryum norrisii photo 1
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo1">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1wksM3hIKGuUQh6S-rovbWuSWh--rKdua" title="Andrew Simon" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Mosses&#x2F;Pottiaceae&#x2F;Vinealobryum_norrisii&#x2F;macro_pics&#x2F;VINENOR_AS_iNat_02.jpg)"
       title="Andrew Simon">
    <div class="imerss-image-copy"> © Andrew Simon</div>
  </div>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo2">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo2">
                      Vinealobryum norrisii photo 2
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo2">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1f9FQQGepSgclgvst-7mnE3KlQt8xZvBy" title="Andrew Simon" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Mosses&#x2F;Pottiaceae&#x2F;Vinealobryum_norrisii&#x2F;macro_pics&#x2F;VINENOR_AS_iNat_03.jpg)"
       title="Andrew Simon">
    <div class="imerss-image-copy"> © Andrew Simon</div>
  </div>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo3">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo3">
                      Vinealobryum norrisii photo 3
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo3">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;18LehqeIbO3E-Ic4hU8IuVuosFbk40zjJ" title="Andrew Simon" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
...
XXXXXX
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Vinealobryum norrisii.csv"); 
 </script>
