...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Mannia gracilis</div>
...
<span class="scientific-name">Mannia gracilis (F.Weber) D.B.Schill &amp; D.G.Long</span>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo3">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo3">
                      Mannia gracilis photo 3
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo3">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1A9nZgU4KYpNbb0I58LiW-WLMLJNZsm4W" title="Braden Judson" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
...
<h2 id="associated-species">Associated species</h2>
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Mannia gracilis.csv"); 
 </script>
