---
title: Bartramiopsis lescurii
url: /taxa/Bartramiopsis lescurii
image: "../img/Mosses&#x2F;Bartramiaceae&#x2F;Bartramiopsis_lescurii&#x2F;macro_pics&#x2F;Bartramiopsis_lescurii_JR_01.jpg"
categories:
  - Bryophyta
---
...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Bartramiopsis lescurii</div>
   ...
   <div class="taxon-rank rank-genus">
     ...
     <span class="taxon-rank-value"><a href="/taxa/Bartramiopsis">Bartramiopsis</a></span>
   </div>
  <div class="taxon-scientific"><span class="scientific-label">Scientific Name: </span>
<a href="https://www.gbif.org/species/">
<span class="scientific-name">Bartramiopsis lescurii (James) Kindb.</span>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo1">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo1">
                      Bartramiopsis lescurii photo 1
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo1">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1W6WDUBGOSWtHSkEFIaiCCMbtcSgUrKHk" title="John Reynolds" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo2">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo2">
                      Bartramiopsis lescurii photo 2
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo2">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1W-Yrs81S1RE7fnRVqsY8X5AOt_68VcsF" title="John Reynolds" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo3">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo3">
                      Bartramiopsis lescurii photo 3
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo3">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1W6EnqHMnv7Yi98Um0uULXuyh-gp4OfE3" title="Braden Judson" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
...
<h2 id="associated-species">Associated species</h2>
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Bartramiopsis lescurii.csv"); 
 </script>
