...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Scapania subalpina</div>
...
<span class="scientific-name">Scapania subalpina (Nees ex Lindenb.) Dumort.</span>
...
<table>
<tr><td class="info-label">Common Name</td><td class="info-value">Northern Earwort</td></tr>
...
Only one other regional species of <a href="/taxa/Scapania">Scapania</a> has upper and lower lobes so close in size. <a href="/taxa/Scapania obscura">Scapania obscura</a>, however, has a rounded keel and brown pigmentation, while S. subalpina has an sharp keel and gold-to-red pigmentation. 
...
XXXXXX
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Scapania subalpina.csv"); 
 </script>
