---
title: Mylia anomala
url: /taxa/Mylia anomala
image: "../img/Liverworts&#x2F;Myliaceae&#x2F;Mylia_anomala&#x2F;Mylia_anomala_JR_02.jpg"
categories:
  - Marchantiophyta
---
...
<div class="info-panel">
 <div class="info-left">
  <div class="taxon-name">Mylia anomala</div>
   ...
   <div class="taxon-rank rank-family">
     ...
     <span class="taxon-rank-value"><a href="/taxa/Myliaceae">Myliaceae</a></span>
   </div>
...
<a href="https://www.gbif.org/species/ (Hook.) Gray</span>
...
<table>
<tr><td class="info-label">Common Name</td><td class="info-value">Anomalous Flapwort</td></tr>
<tr><td class="info-label">Frequency</td><td class="info-value">Locally frequent in bogs</td></tr>
</table>
 </div>
</div>
...
<div class="imerss-image-header">
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Liverworts&#x2F;Myliaceae&#x2F;Mylia_anomala&#x2F;Mylia_anomala_JR_02.jpg)"
       title="John Reynolds">
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo1">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo1">
                      Mylia anomala photo 1
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo1">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1Ftl9uUGSEyfovss1GYkRk9Ac-JjpitiO" title="John Reynolds" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Liverworts&#x2F;Myliaceae&#x2F;Mylia_anomala&#x2F;Mylia_anomala_JR_01.jpg)"
       title="John Reynolds">
    <div class="imerss-image-copy"> © John Reynolds</div>
  </div>
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo2">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo2">
                      Mylia anomala photo 2
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo2">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1FvdbxUJreotf9Tz25hN-97KMgxMeFmzM" title="John Reynolds" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="imerss-image-holder"
       ...
       style="background-image: url(../../img/Liverworts&#x2F;Myliaceae&#x2F;Mylia_anomala&#x2F;Mylia_anomala_CW_01.jpeg)"
          ...
          <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-plate-title-photo3">
              <header class="modal__header">
                  <div class="modal__title" id="modal-plate-title-photo3">
                      Mylia anomala photo 3
                  </div>
                  <button class="modal__close" aria-label="Close" data-micromodal-close></button>
              </header>
              <div class="modal__content" id="modal-plate-content-photo3">
                  <img src="https:&#x2F;&#x2F;lh3.googleusercontent.com&#x2F;d&#x2F;1Fo5pa3xdvnyzHLRuLLd-NaGPTHjgRMxQ" title="Connor Wardrop" referrerpolicy="no-referrer"/>
              </div>
          </div>
      </div>
  </div>
...
<a href="/taxa/Mylia">Mylia</a> anomala is seemingly restricted to bog and fen habitats, where it worms its way through Sphagnum, presenting at the surface as oppositely-arranged and converging elongate-oval leaves dusted with yellow-green asexual spores ("gemmae"), like a set of lips bearing a clump of cornmeal. Yanked from their substrate, the shoots are long (up to 3 cm), with the simple, unlobed leaves attaching obliquely to the stem and becoming more distantly spaced as you move down. 

<h2 id="similar-species">Similar species</h2>

This is the only large simple-leaved liverwort that grows exclusively through Sphagnum and has abundant yellow-green gemmae. The presence of prominent simple underleaves seperates it from Cryptocolea, Syzygiella, <a href="/taxa/Jungermannia">Jungermannia</a> and Solenostoma. Because of its restriction to bog-like habitats, it could only be mistaken for the much smaller species of <a href="/taxa/Odontoschisma">Odontoschisma</a> (<<1 mm wide) or its brethren, <a href="/taxa/Mylia taylorii">Mylia taylorii</a>. The latter species has leaves wider than long with rounded leaf tips topped by bright yellow-red gemmae, while those of M. anomala are longer than wide, with somewhat pointed leaf tips topped by light green gemmae. 
...
XXXXXX
 ...
 <script type="module">
    imerss.makeRecordsMap("imerss-map-holder", "../../taxa_records/Mylia anomala.csv"); 
 </script>
